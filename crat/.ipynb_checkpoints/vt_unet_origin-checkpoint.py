...
class SwinTransformerSys3D(nn.Module):
    ...
    def forward_features(self, x):
        ...
        for i, layer in enumerate(self.layers):
            ...
            x, v1, k1, q1, v2, k2, q2 = layer(x, i) # (1, 72, 32, 32, 32) -> (1, 144, 32, 16, 16)
        ...
        x = rearrange(x, 'n c d h w -> n d h w c') # (1, 576, 32, 4, 4) -> (1, 32, 4, 4, 576)
        x = self.norm(x)
        x = rearrange(x, 'n d h w c -> n c d h w') # (1, 32, 4, 4, 576) -> (1, 576, 32, 4, 4)
